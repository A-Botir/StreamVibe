const FormInfo = () => {
  return (
    <div className="mb-[70px] grid grid-cols-5 items-start justify-between gap-[50px] sm:mb-[40px] sm:grid-cols-1 lg:mb-[100px] xl:mb-[140px]">
      <div className="col-span-2 sm:col-span-1 sm:m-auto">
        ...
        <div className="h-[300px] w-full rounded-[4px] border-4 border-[#262626] bg-[url('./images/picture/suppImg.png')] bg-cover bg-center bg-no-repeat sm:h-[250px]  lg:h-[325px] xl:h-[500px]"></div>
      </div>
      <form
        action="#"
        className="col-span-3 flex grow flex-col gap-5 rounded-[10px] bg-[#0F0F0F] p-8 sm:col-span-1 sm:p-6 lg:p-[40px] xl:gap-[50px] xl:rounded-xl xl:p-[50px]"
      >
